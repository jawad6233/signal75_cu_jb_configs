...
AF_COEF_T get_AF_Coef()
{
    ...
    // -------------------------------    
    sAFcoef.i4ZSD_GS_CHANGE_THRES   = 30;    
    sAFcoef.i4ZSD_GS_CHANGE_OFFSET  = 10000;    
    sAFcoef.i4ZSD_GS_CHANGE_CNT     = 4;

    sAFcoef.i4ZSD_FV_CHANGE_THRES   = 15;
    ...
    sAFcoef.i4ZSD_FV_STABLE2_NUM    = 3;                        
    sAFcoef.i4ZSD_FV_STABLE2_CNT    = 3;                        
