...
const TCFG_FILE g_akCFG_File[]=
{
   ...
   //	CFG_FILE_added_CONFIG_TOTAL,		    SIGNLE_DEFUALT_REC,				    (char *)&stAddedDefault},
    //<2012/11/12 serenasun 17421: add nvram for psensor calibration data 
	{ "/data/nvram/APCFG/APRDCL/Psensor_Cal_Data_H",   VER(AP_CFG_RDCL_FILE_PSENSOR_CAL_DATA_H_LID), CFG_FILE_PSENSOR_H_REC_SIZE,
        CFG_FILE_PSENSOR_H_REC_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&stProximiteSensorDefault, DataReset , NULL
    },
    { "/data/nvram/APCFG/APRDCL/Psensor_Cal_Data_L",   VER(AP_CFG_RDCL_FILE_PSENSOR_CAL_DATA_L_LID), CFG_FILE_PSENSOR_L_REC_SIZE,
        CFG_FILE_PSENSOR_L_REC_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&stProximiteSensorLDefault, DataReset , NULL
    },
    //<2012/11/12 serenasun 17421
};
...
#endif
    //<2012/11/12 serenasun 17421: add nvram for psensor calibration data 
    {"Psensor_Cal_Data_H",AP_CFG_RDCL_FILE_PSENSOR_CAL_DATA_H_LID},
    {"Psensor_Cal_Data_L",AP_CFG_RDCL_FILE_PSENSOR_CAL_DATA_L_LID},
    //<2012/11/12 serenasun 17421 
};
